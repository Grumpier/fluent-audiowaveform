    ...
    var api = {
        ...
        toPng: function (options) {
            ...
            args = [    
                ...
                " --waveform-color 1976d2FF",
                " --axis-label-color FFFFFFFF",
                " --border-color 00000000"
            ]
//            args = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], baseArgs), outputFormat), zoom), width), height), colors), borderColor), backgroundColor), waveformColor), axisLabelColor);
            return api;
        },
        bits: function (bits) {
            var baseArgs = args;
