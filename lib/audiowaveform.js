...
var AudioWaveform = function () {
    ...
    var api = {
        ...
        toPng: function (options) {
            ...
            // ]
            args = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], baseArgs), outputFormat), width), height), zoom), borderColor), backgroundColor), waveformColor), axisLabelColor);
            console.log(args)
            return api;
        },
        bits: function (bits) {
